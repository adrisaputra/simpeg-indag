				...
				<center><p style="font-size:20px">DATA PENDIDIKAN</p></center>
					...
					<div class="form-group @if ($errors->has('nama_sekolah')) has-error @endif">
						...
						<div class="col-sm-9">
							...
							<input type="text" class="form-control" placeholder="Nama Sekolah / Institusi" name="nama_sekolah" value="{{ old('nama_sekolah') }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('jurusan')) has-error @endif">
						...
						<div class="col-sm-9">
							...
							<input type="text" class="form-control" placeholder="Nama Jurusan / Program Studi" name="jurusan" value="{{ old('jurusan') }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('no_ijazah')) has-error @endif">
						...
						<div class="col-sm-9">
							...
							<input type="text" class="form-control" placeholder="No. Ijazah" name="no_ijazah" value="{{ old('no_ijazah') }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('tahun_ijazah')) has-error @endif">
						...
						<div class="col-sm-9">
							...
							<input type="text" class="form-control" placeholder="Tahun Ijazah" name="tahun_ijazah" value="{{ old('tahun_ijazah') }}" >
