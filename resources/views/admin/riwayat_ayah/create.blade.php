...
<section class="content-header">
	...
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title">Tambah Data Ayah</h3>
		</div>
		
		<form action="{{ url('/riwayat_ayah/'.$pegawai[0]->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		{{ csrf_field() }}
			<div class="box-body">
				<div class="col-lg-12">
				...
				<center><p style="font-size:20px">DATA AYAH</p></center>
					...
					<div class="form-group @if ($errors->has('nama_ayah')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Nama Ayah" name="nama_ayah" value="{{ old('nama_ayah') }}" >
						</div>
					</div>
