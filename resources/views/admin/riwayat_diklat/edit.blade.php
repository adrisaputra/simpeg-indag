				...
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('kelompok_diklat')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<select class="form-control" name="kelompok_diklat">
                                        ...
                                        <option value="kelompok Diklat Fungsional" @if($riwayat_diklat->kelompok_diklat=="kelompok Diklat Fungsional") selected @endif> kelompok Diklat Fungsional</option>
                                        <option value="kelompok Diklat Struktural" @if($riwayat_diklat->kelompok_diklat=="kelompok Diklat Struktural") selected @endif> kelompok Diklat Struktural</option>
                                        <option value="kelompok Diklat Teknis" @if($riwayat_diklat->kelompok_diklat=="kelompok Diklat Teknis") selected @endif> kelompok Diklat Teknis</option>
                                        <option value="kelompok Diklat Prakelompok_diklat" @if($riwayat_diklat->kelompok_diklat=="kelompok Diklat Prakelompok_diklat") selected @endif> kelompok Diklat Prakelompok_diklat</option>
                                    </select>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('jenis_diklat')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<select class="form-control" name="jenis_diklat">
                                        ...
                                        <option value="Jenis Diklat  Fungsional" @if($riwayat_diklat->jenis_diklat=="Jenis Diklat  Fungsional") selected @endif> Jenis Diklat  Fungsional</option>
                                        <option value="Jenis Diklat  Struktural" @if($riwayat_diklat->jenis_diklat=="Jenis Diklat  Struktural") selected @endif> Jenis Diklat  Struktural</option>
                                        <option value="Jenis Diklat  Teknis" @if($riwayat_diklat->jenis_diklat=="Jenis Diklat  Teknis") selected @endif> Jenis Diklat  Teknis</option>
                                        <option value="Jenis Diklat  Prajenis_diklat" @if($riwayat_diklat->jenis_diklat=="Jenis Diklat  Prajenis_diklat") selected @endif> Jenis Diklat  Prajenis_diklat</option>
                                    </select>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('negara')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<select class="form-control" name="negara">
                                        ...
                                        <option value="Negara  Fungsional" @if($riwayat_diklat->negara=="Negara  Fungsional") selected @endif> Negara  Fungsional</option>
                                        <option value="Negara  Struktural" @if($riwayat_diklat->negara=="Negara  Struktural") selected @endif> Negara  Struktural</option>
                                   </select>
						</div>
					</div>
					...
					<div class="form-group  @if ($errors->has('lokasi') || $errors->has('kota')) has-error @endif">
						...
						<div class="col-sm-3" @if($errors->has('lokasi') && $errors->has('kota')) @elseif ($errors->has('kota')) style="padding-top:27px" @endif>
							...
							<select class="form-control" name="lokasi"  @if($riwayat_diklat->lokasi) style="border-color: #d3d7df;" @endif>
                                        <option value=""> -Pilih Lokasi -</option>
                                        <option value="Lokasi  Fungsional" @if($riwayat_diklat->lokasi=="Lokasi  Fungsional") selected @endif> Lokasi  Fungsional</option>
                                        <option value="Lokasi  Struktural" @if($riwayat_diklat->lokasi=="Lokasi  Struktural") selected @endif> Lokasi  Struktural</option>
                                   </select>
						</div>
					...
					<div class="form-group @if ($errors->has('kualitas')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<select class="form-control" name="kualitas">
                                        ...
                                        <option value="Kualitas  Fungsional" @if($riwayat_diklat->kualitas=="Kualitas  Fungsional") selected @endif> Kualitas  Fungsional</option>
                                        <option value="Kualitas  Struktural" @if($riwayat_diklat->kualitas=="Kualitas  Struktural") selected @endif> Kualitas  Struktural</option>
                                   </select>
						</div>
					</div>
