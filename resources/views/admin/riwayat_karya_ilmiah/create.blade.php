					...
					<div class="form-group @if ($errors->has('jenis_kegiatan')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<select class="form-control" name="jenis_kegiatan">
                                        ...
                                        <option value="Jenis Kegiatan  Fungsional" @if(old('jenis_kegiatan')=="Jenis Kegiatan  Fungsional") selected @endif> Jenis Kegiatan  Fungsional</option>
                                        <option value="Jenis Kegiatan  Struktural" @if(old('jenis_kegiatan')=="Jenis Kegiatan  Struktural") selected @endif> Jenis Kegiatan  Struktural</option>
                                        <option value="Jenis Kegiatan  Teknis" @if(old('jenis_kegiatan')=="Jenis Kegiatan  Teknis") selected @endif> Jenis Kegiatan  Teknis</option>
                                        <option value="Jenis Kegiatan  Prajenis_kegiatan" @if(old('jenis_kegiatan')=="Jenis Kegiatan  Prajenis_kegiatan") selected @endif> Jenis Kegiatan  Prajenis_kegiatan</option>
                                    </select>
						</div>
					</div>
