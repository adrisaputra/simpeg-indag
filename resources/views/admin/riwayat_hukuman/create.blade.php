				...
				<center><p style="font-size:20px">DATA HUKUMAN</p></center>
					...
					<div class="form-group @if ($errors->has('nama_hukuman')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Nama Hukuman" name="nama_hukuman" value="{{ old('nama_hukuman') }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('uraian_hukuman')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<textarea class="form-control" placeholder="Uraian Hukuman" name="uraian_hukuman">{{ old('uraian_hukuman') }}</textarea>
						</div>
					</div>
