			...
			<div class="box-body">
				...
				<center><p style="font-size:20px">DATA KEPANGKATAN</p></center>
					...
					<div class="form-group @if ($errors->has('periode_kp')) has-error @endif">
						<label class="col-sm-2 control-label">{{ __('Periode KP') }} <span class="required" style="color: #dd4b39;">*</span></label>
						<div class="col-sm-10">
							...
							<select class="form-control" name="periode_kp">
                                        ...
                                        <option value="Periode KP II/a" @if(old('periode_kp')=="Periode KP II/a") selected @endif> Periode KP II/a</option>
                                    </select>
						</div>
					</div>
					...
					<div class="form-group  @if ($errors->has('golongan') || $errors->has('status')) has-error @endif">
						...
						<div class="col-sm-3" @if($errors->has('golongan') && $errors->has('status')) @elseif ($errors->has('golongan')) style="padding-top:27px" @endif>
							...
							<select class="form-control" name="status" @if(old('status')) style="border-color: #d3d7df;" @endif>
                                        <option value=""> -Pilih Status-</option>
                                        <option value="Status II/a" @if(old('status')=="Status II/a") selected @endif> Status II/a</option>
                                    </select>
						</div>
					</div>
