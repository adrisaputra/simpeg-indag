			...
			<div class="box-body">
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('nama_pasangan')) has-error @endif">
						<label class="col-sm-2 control-label">{{ __('Nama Suami/Istri') }}</label>
						<div class="col-sm-10">
					...
					<div class="form-group @if ($errors->has('tempat_lahir')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Tempat Lahir" name="tempat_lahir" value="{{ $riwayat_pasangan->tempat_lahir }}" >
						</div>
					</div>
