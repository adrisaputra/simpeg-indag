				...
				<center><p style="font-size:20px">DATA KURSUS</p></center>
					...
					<div class="form-group @if ($errors->has('nama_kursus')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Nama Kursus" name="nama_kursus" value="{{ old('nama_kursus') }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('tempat')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Tempat Kursus" name="tempat" value="{{ old('tempat') }}" >
						</div>
					</div>
